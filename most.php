...
die ('Nisu popunjena zatražena polja.<br><a href="most.php"> Pokušajte ponovo. </a>');
}
...
if ($check2 == 0) {
die ('Ne postoji takav korisnik.<br><a href="most.php"> Pokušajte ponovo. </a>');
}
while($info = mysql_fetch_array( $check )) 
{
...
die ('Lozinka nije valjana.<br><a href="most.php"> Pokušajte ponovo. </a>');
}
else 
{  
