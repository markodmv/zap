...
class registracijafirmi extends stranica{
	function Prikaz(){
	$this -> PrikazPP();
...
{
header("Location: registracijafirmir.php");
}
}
}
	}
...
<?
echo "Da bi mogli registrirati firmu morate biti korisnik!";
...
die ('Nisu popunjena zatražena polja.<br><a href="registracijafirmi.php"> Pokušajte ponovo. </a>');
}
...
if ($check2 == 0) {
die ('Ne postoji takav korisnik.<br><a href="registracijafirmi.php"> Pokušajte ponovo. </a>');
}
while($info = mysql_fetch_array( $check )) 
{
...
die ('Lozinka nije valjana.<br><a href="ragistracijafirmi.php"> Pokušajte ponovo. </a>');
}
else 
{  
...
$registracijafirmi = new registracijafirmi();
$registracijafirmi -> Prikaz();
ob_flush();
?>