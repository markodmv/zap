...
class dodavanje extends stranica{
	function Prikaz(){
	$this -> PrikazPP();
...
{
header("Location: dodavanjer.php");
}
}
}
	}
...
<?
echo "Da bi mogli dodati potraživanje morate biti korisnik!";
...
die ('Nisu popunjena zatražena polja.<br><a href="dodavanje.php"> Pokušajte ponovo. </a>');
}
...
if ($check2 == 0) {
die ('Ne postoji takav korisnik.<br><a href="dodavanje.php"> Pokušajte ponovo. </a>');
}
while($info = mysql_fetch_array( $check )) 
{
...
die ('Lozinka nije valjana.<br><a href="dodavanje.php"> Pokušajte ponovo. </a>');
}
else 
{  
