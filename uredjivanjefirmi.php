...
class uredjivanjefirmi extends stranica{
	function Prikaz(){
	$this -> PrikazPP();
...
{
header("Location: uredjivanjefirmir.php");
}
}
}
	}
...
<?
echo "Da bi mogli uređivati podatke o firmama morate biti korisnik!";
...
die ('Nisu popunjena zatražena polja.<br><a href="uredjivanjefirmi.php"> Pokušajte ponovo. </a>');
}
...
if ($check2 == 0) {
die ('Ne postoji takav korisnik.<br><a href="uredjivanjefirmi.php"> Pokušajte ponovo. </a>');
}
while($info = mysql_fetch_array( $check )) 
{
...
die ('Lozinka nije valjana.<br><a href="uredjivanjefirmi.php"> Pokušajte ponovo. </a>');
}
else 
{  
...
$uredjivanjefirmi = new uredjivanjefirmi();
$uredjivanjefirmi -> Prikaz();
ob_flush();
?>