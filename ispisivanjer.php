...
class ispisivanjer extends stranica{
	function Prikaz(){
...
else 
{
	$id = $info['korisnik_id'];
	$status = $info['status'];
	if($status < 2){echo "Da bi mogli dobiti ispis potraživanja morate imati odobrenje od strane administratora.<br> (Administrator vam mora promijeniti status.)!<br><br>";
...
<br /><br />
  ...
  ?>
    ...
    <tr>
    <td align="center" height="60"><input type="submit" name="prikazp" value="Prikaži potraživanja" />
                        <input type="submit" name="prikazd" value="Prikaži dugovanja" /></td>
  </tr>
    <tr>
    <td valign="top"><br /><br />
    <?
