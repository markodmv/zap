...
class kompenzacijer extends stranica{
	function Prikaz(){
...
if ($pass != $info['lozinka']) 
	...
	{
		$status = $info['status'];
	if($status < 2){echo "Da bi mogli ispisati kompenzacije morate imati odobrenje od strane administratora.<br> (Administrator vam mora promijeniti status.)!<br><br>";
...
if(!$fimo=mysql_query($sqlo)){echo"<br>Nastala je greška pri izvođenju upita!<br>".mysql_query();}
  ...
  while ($redak=mysql_fetch_array($s))
  {
		...
		echo "<p> - $potnaz ............... $d</p>";
						...
						echo "<br><a href=\"detaljr.php?firm1=$pot1&firm2=$pot2&firm3=$pot3&firm4=$pot4&firm5=$dug4\">Ispis detalja</a><br>";
						echo "<hr width=\"55%\" align=\"left\"><br>";	
						break;
												}
  ...
  while ($redak=mysql_fetch_array($s))
  {
	  if($i==1) $d=$d1;
		...
		echo "<p> - $potnaz ............... $d</p>";
							...
							echo "<br><a href=\"detaljr.php?firm1=$pot1&firm2=$pot2&firm3=$pot3&firm4=$pot4&firm5=$pot5&firm6=$dug5\">Ispis detalja</a><br>";
						echo "<hr width=\"55%\" align=\"left\"><br>";
						break;
															}
  ...
  while ($redak=mysql_fetch_array($s))
  {
	  ...
	  if($i==2) $d=$d2;
		...
		echo "<p> - $potnaz ............... $d</p>";
						...
						echo "<br><a href=\"detaljr.php?firm1=$pot1&firm2=$pot2&firm3=$pot3&firm4=$pot4&firm5=$pot5&firm6=$pot6&firm7=$dug6\">Ispis detalja</a><br>";
						echo "<hr width=\"55%\" align=\"left\"><br>";	
						break;
																		}
  ...
  while ($redak=mysql_fetch_array($s))
  {
		...
		echo "<p> - $potnaz ............... $d</p>";
					...
					echo "<br><a href=\"detaljr.php?firm1=$pot1&firm2=$pot2&firm3=$pot3&firm4=$pot4&firm5=$pot5&firm6=$pot6&firm7=$pot7&firm8=$dug7\">Ispis detalja</a><br>";
						echo "<hr width=\"55%\" align=\"left\"><br>";	
						break;
																		}
  ...
  while ($redak=mysql_fetch_array($s))
  {
		...
		echo "<p> - $potnaz ............... $d</p>";
							...
							echo "<br><a href=\"detaljr.php?firm1=$pot1&firm2=$pot2&firm3=$pot3&firm4=$pot4&firm5=$pot5&firm6=$pot6&firm7=$pot7&firm8=$pot8&firm9=$dug8\">Ispis detalja</a><br>";
						echo "<hr width=\"55%\" align=\"left\"><br>";	
						break;
																		}
  ...
  while ($redak=mysql_fetch_array($s))
  {
		...
		echo "<p> - $potnaz ............... $d</p>";
						...
						echo "<br><a href=\"detaljr.php?firm1=$pot1&firm2=$pot2&firm3=$pot3&firm4=$pot4&firm5=$pot5&firm6=$pot6&firm7=$pot7&firm8=$pot8&firm9=$pot9&firm10=$dug9\">Ispis detalja</a><br>";
						echo "<hr width=\"55%\" align=\"left\"><br>";	
						break;
																		}
  ...
  while ($redak=mysql_fetch_array($s))
  {
		...
		echo "<p> - $potnaz ............... $d</p>";
						...
						echo "<br><a href=\"detaljr.php?firm1=$pot1&firm2=$pot2&firm3=$pot3&firm4=$pot4&firm5=$pot5&firm6=$pot6&firm7=$pot7&firm8=$pot8&firm9=$pot9&firm10=$pot10&firm11=$dug10\">Ispis detalja</a><br>";
						echo "<hr width=\"55%\" align=\"left\"><br>";	
						break;
																		}
  ...
  while ($redak=mysql_fetch_array($s))
  {
		...
		echo "<p> - $potnaz ............... $d</p>";
						...
						echo "<br><a href=\"detaljr.php?firm1=$pot1&firm2=$pot2&firm3=$pot3&firm4=$pot4&firm5=$pot5&firm6=$pot6&firm7=$pot7&firm8=$pot8&firm9=$pot9&firm10=$pot10&firm11=$pot11&firm12=$dug11\">Ispis detalja</a><br>";
						echo "<hr width=\"55%\" align=\"left\"><br>";
						break;
																		}
  ...
  while ($redak=mysql_fetch_array($s))
  {
		...
		echo "<p> - $potnaz ............... $d</p>";
						...
						echo "<br><a href=\"detaljr.php?firm1=$pot1&firm2=$pot2&firm3=$pot3&firm4=$pot4&firm5=$pot5&firm6=$pot6&firm7=$pot7&firm8=$pot8&firm9=$pot9&firm10=$pot10&firm11=$pot11&firm12=$pot12&firm13=$dug12\">Ispis detalja</a><br>";
						echo "<hr width=\"55%\" align=\"left\"><br>";
						break;
																		}
  ...
  while ($redak=mysql_fetch_array($s))
  {
		...
		echo "<p> - $potnaz ............... $d</p>";
						...
						echo "<br><a href=\"detaljr.php?firm1=$pot1&firm2=$pot2&firm3=$pot3&firm4=$pot4&firm5=$pot5&firm6=$pot6&firm7=$pot7&firm8=$pot8&firm9=$pot9&firm10=$pot10&firm11=$pot11&firm12=$pot12&firm13=$pot13?firm14=$dug13\">Ispis detalja</a><br>";
						echo "<hr width=\"55%\" align=\"left\"><br>";	
						break;
																		}
  ...
  while ($redak=mysql_fetch_array($s))
  {
		...
		echo "<p> - $potnaz ............... $d</p>";
						...
						echo "<br><a href=\"detaljr.php?firm1=$pot1&firm2=$pot2&firm3=$pot3&firm4=$pot4&firm5=$pot5&firm6=$pot6&firm7=$pot7&firm8=$pot8&firm9=$pot9&firm10=$pot10&firm11=$pot11&firm12=$pot12&firm13=$pot13?firm14=$pot14&firm15=$dug14\">Ispis detalja</a><br>";
						echo "<hr width=\"55%\" align=\"left\"><br>";
						break;
																		}
  ...
  while ($redak=mysql_fetch_array($s))
  {
		...
		echo "<p> - $potnaz ............... $d</p>";
						...
						echo "<br><a href=\"detaljr.php?firm1=$pot1&firm2=$pot2&firm3=$pot3&firm4=$pot4&firm5=$pot5&firm6=$pot6&firm7=$pot7&firm8=$pot8&firm9=$pot9&firm10=$pot10&firm11=$pot11&firm12=$pot12&firm13=$pot13?firm14=$pot14&firm15=$pot15&firm16=$dug15\">Ispis detalja</a><br>";
						echo "<hr width=\"55%\" align=\"left\"><br>";
						break;
																		}
...
$kompenzacijer = new kompenzacijer();
$kompenzacijer -> Prikaz();
ob_flush();
?>